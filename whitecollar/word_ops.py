...
WORD_COM_REQUIRED_ARGS = {
    ...
    "word_live_apply_style": {"style_name"},
    "word_live_add_hyperlink": {"url"},
    "word_live_remove_hyperlink": set(),
    "word_live_add_note": {"text"},
    "word_live_update_fields": set(),
    "word_live_insert_toc": set(),
    "word_live_set_content_control": {"title", "value"},
    "word_live_remove_header_footer": set(),
    "word_live_export_pdf": set(),
    "word_live_set_protection": {"protection_type"},
    "word_live_compare_documents": {"source_path"},
    "word_live_merge_document": {"source_path"},
